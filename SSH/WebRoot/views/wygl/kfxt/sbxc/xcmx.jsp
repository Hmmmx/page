...
<html>
<head>
    <title>设备巡查明细 - 社区运营管理统一工作平台</title>
</head>
<body>
	<div id="wgKfSbxcXcmxCntr">
			...
			<div class="col-12 p-relative">
                ...
                <div class="filterbar">
					...
					<div class="form-group row">
	                    ...
	                    <label for="wgKfSbxcXcmx_f_xcrqq_p" class="col-md-1 col-3xl-1 col-form-label col-form-label-sm">巡查时间</label>
	                	<div class="col-md-4 col-3xl-3 d-flex align-items-center justify-content-between">
	                		<div class="input-group input-group-sm date" style="display:inline-flex;width:47%;" id="wgKfSbxcXcmx_f_xcrqq_p" data-target-input="nearest" data-cx-ctrl="date-time">
					            <input type="text" class="form-control datetimepicker-input" data-target="#wgKfSbxcXcmx_f_xcrqq_p" id="wgKfSbxcXcmx_f_xcrqq" name="xcrqq" value=""  maxlength="16" autocomplete="off" novalidate>
					            <div class="input-group-append" data-target="#wgKfSbxcXcmx_f_xcrqq_p" data-toggle="datetimepicker">
					        ...
					        <div class="input-group input-group-sm date" style="display:inline-flex;width:47%;" id="wgKfSbxcXcmx_f_xcrqz_p" data-target-input="nearest" data-cx-ctrl="date-time">
					            <input type="text" class="form-control datetimepicker-input" data-target="#wgKfSbxcXcmx_f_xcrqz_p" id="wgKfSbxcXcmx_f_xcrqz" name="xcrqz" value=""  maxlength="16" autocomplete="off" novalidate>
					            <div class="input-group-append" data-target="#wgKfSbxcXcmx_f_xcrqz_p" data-toggle="datetimepicker">
					                <button class="btn btn-outline-secondary input-group-fix" type="button"><i class="fas fa-calendar-alt"></i></button>
					            </div>
					            <div class="invalid-tooltip">时间格式不正确</div>
					        </div>
				...
				<div class="main-content">
                    <div class="table-responsive fit2height-pgr">
						<table class="table table-sm table-zebra table-hover table-fixed table-wgkf-sbxc-xcmx fixed-thead fixed-row-1st-cell">
	...
	<script src="<s:url value="${StaticRsrcUtil.appendVersion('/resources/js/wygl/kfxt/sbxc/xcmx.js') }" />"></script>
</body>
</html>