...
<body data-print-page-size="11">
	<div class="print-wrapper print-page-break fs-xs" v-for="(page, index) in data.sfpzmxPages">
		<div>
			<h4 class="title" style="padding-top:1em;"><span>收费通知</span></h4> <!-- 不同设备可能需要调整padding-top -->
			
			<div class="wrapper">
				<div class="row">
					<div class="col-6">房产名称：{{data.sfpz.fcmc}}</div>
					<div class="col-3">客户名称：{{data.sfpz.khmc}}</div>
					<div class="col-3 text-right">通知日期：{{data.sfpz.tzrq}}</div>
				</div>
			</div>
			...
			<div class="wrapper mt-2">
				<div class="row">
					<div class="col-10">请合理安排时间完成交费，以免产生不必要的违约金</div>
					<div class="col-2 text-right">经办人：{{data.sfpz.skrmc}}</div>
				</div>
			</div>
			<div class="wrapper mt-2">
