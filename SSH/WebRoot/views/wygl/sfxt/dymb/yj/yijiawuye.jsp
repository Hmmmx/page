...
<body data-print-page-size="10">
	<div class="print-wrapper print-page-break fs-xs" v-for="(page, index) in data.sfpzmxPages">
		<div>
			<h4 class="title" style="padding-top:1em;"><span>押金收据</span></h4> <!-- 不同设备可能需要调整padding-top -->
				...
				<table class="table border-h-tbody-none" border="0" cellspacing="0"> <!-- border, border-h, border-h-tbody-none -->
				    <thead class="thead-light">
				        <tr>
				            ...
				            <th class="text-center" style="width:13em;">收取时间</th>
					...
					<tbody>
						<tr v-for="sfpzmx in page.sfpzmxs">
							<td>{{sfpzmx.yjlxmc}}</td>
							<td class="text-center f-family-regular">{{sfpzmx.skrq}}</td>
					...
					<tfoot>
						<tr>
							<td colspan="2">合计（大写）：{{data.stat.zwdxTotal}}</td>
