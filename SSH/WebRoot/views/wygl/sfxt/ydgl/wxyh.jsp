...
<html>
<head>
    <title>微信用户管理 - 社区运营管理统一工作平台</title>
</head>
<body>
	<div id="wgSfYdWxyhCntr">
			...
			<div class="col-12 p-relative">
                ...
                <div class="filterbar">
					...
					<div class="form-group row">
		                ...
		                <label for="wgSfYdWxyh_f_gzzt" class="col-md-1 col-3xl-1 col-form-label col-form-label-sm">绑定状态</label>
	                    <div class="col-md-3 col-3xl-2">
	                        <select class="custom-select custom-select-sm" id="wgSfYdWxyh_f_gzzt" name="gzzt">
				...
				<div class="main-content">
                    <div class="table-responsive fit2height-pgr">
						<table class="table table-sm table-zebra table-hover table-fixed table-wgsf-yd-wxyh fixed-thead fixed-row-1st-cell">
	...
	<script src="<s:url value="${StaticRsrcUtil.appendVersion('/resources/js/wygl/sfxt/ydgl/wxyh.js') }" />"></script>
</body>
</html>