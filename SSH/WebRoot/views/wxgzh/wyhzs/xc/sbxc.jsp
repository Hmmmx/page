...
<head>
	...
	<script src="<s:url value="${StaticRsrcUtil.appendVersion('/resources/js/wxgzh/wyhzs/xc/sbxc.js')}" />"></script>
</head>
<body class="snow" data-root-url="<s:url value="/" />">
	<div class="page-title page-wide">
		<div>
			<i class="fas fa-clipboard-check text-primary mr-1"></i><span>设备巡查</span>
		</div>
	...
	<div class="page-body">		
		<div class="sbxc-list-wrapper">
			<div class="sbxc-list-body"></div>
		</div>
	</div>
