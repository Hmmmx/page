...
<head>
	...
	<script src="<s:url value="${StaticRsrcUtil.appendVersion('/resources/js/wxgzh/wyhzs/xc/baxc-add.js')}" />"></script>
</head>
<body class="light" data-root-url="<s:url value="/" />">
	<div class="page-title page-wide">
		<div>
			<i class="fas fa-user-shield text-primary mr-1"></i><span>新增巡查记录</span>
		</div>
		<div class="back">
	...
	<div class="page-body">
		...
		<div class="cx-paragraph cx-pair-list">
            ...
            <div class="cx-pair">
                <div>地点</div>
                <div><span data-f-name="xcdd"></span></div>
            </div>
