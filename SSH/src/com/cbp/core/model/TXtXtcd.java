...
/**
 * TXtXtcd entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "t_xt_xtcd")

public class TXtXtcd implements java.io.Serializable {
	...
	/** minimal constructor */
	public TXtXtcd(String cdid, String cdmc, String sjcdid) {
		this.cdid = cdid;
		this.cdmc = cdmc;
		this.sjcdid = sjcdid;
	}
	...
	/** full constructor */
	public TXtXtcd(String cdid, String cdmc, String url, String sjcdid, String cdlx, Integer plxh, String yxbj,
