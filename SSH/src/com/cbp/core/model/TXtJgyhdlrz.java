...
/**
 * TXtJgyhdlrz entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "t_xt_jgyhdlrz")

public class TXtJgyhdlrz implements java.io.Serializable {
	...
	/** minimal constructor */
	public TXtJgyhdlrz(String dlrzid, String yhid, Timestamp dlsj, String session) {
		this.dlrzid = dlrzid;
		this.yhid = yhid;
		this.dlsj = dlsj;
	...
	/** full constructor */
	public TXtJgyhdlrz(String dlrzid, String yhid, Timestamp dlsj, String dlip, Timestamp tcsj, String zt,
