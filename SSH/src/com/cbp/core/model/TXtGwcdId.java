...
/**
 * TXtGwcdId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class TXtGwcdId implements java.io.Serializable {
	...
	/** full constructor */
	public TXtGwcdId(String gwid, String cdid) {
		this.gwid = gwid;
		this.cdid = cdid;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TXtGwcdId))
			return false;
		TXtGwcdId castOther = (TXtGwcdId) other;
