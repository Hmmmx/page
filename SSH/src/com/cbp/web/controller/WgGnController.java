...
import com.cbp.core.service.WgGnService;
...
*/
@Controller
@RequestMapping(value = "/wgcd")

public class WgGnController extends BaseController {

    @Autowired
    private WgGnService WgGnService;
    
    @GetMapping(value = {"", "/", "/index"})
	public String pageLoad(HttpServletRequest request) {
		return "ptgl/wgxt/menu-wg";
	}
    ...
    public Result updateXtgn(XtcdVo xtcd) {
    	...
    	xtcd.setXgry(xgry);
    	this.WgGnService.updateXtgn(xtcd);
    	return this.success();
    }
    ...
    public Result deleteXtgn() {
    	this.WgGnService.deleteXtgn(this.getRequest().getParameter("cdid"));
    	return this.success();
    }
    ...
    public Result getXtgn() {
    	return this.success(this.WgGnService.getXtgn());
    }
    
    @GetMapping(value="/findXtgn")
    @ResponseBody
    public Result findXtgn() {
    	return this.success(this.WgGnService.findXtgn(this.getRequest().getParameter("cdid")));
    }
